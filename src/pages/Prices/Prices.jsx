  ...
  return (
    <div>
      ...
      <div className="max-w-[1350px] sa:max-w-[980px] xl:max-w-[390px] m-[auto] mt-[102px]">
        <div>
          ...
          <div className="mb-[40px]">
            <h1 className="text-[44px] font-[extrabold] text-[#1F2428] dark:text-[white] leading-[50px] w-[824px] xl:w-[390px] sa:w-[980px]">
              {t("st4.hero-text")}
            </h1>
            <p className="w-[760px] xl:w-[490px] sa:w-[980px] text-[20px] dark:text-[white] text-[#1F2428] leading-[36px] font-[light] mt-[20px]">
              {t("st4.desc")}
            </p>
        ...
        <div className="mt-[170px]">
          <h1 className="text-[44px] font-[extrabold] mb-[40px] text-[#1F2428] dark:text-[white] leading-[50px]">
            {t("st5.hero")}
          </h1>
        ...
        <div className="mt-[299px]">
          <h1 className="text-[44px] font-[extrabold] text-[#1F2428] dark:text-[white] leading-[50px] mb-[40px]">
      ...
      <div className="max-w-[1350px] xl:max-w-[390px] sa:max-w-[980px] m-auto mb-[160px] mt-[160px]">
        <div>
          <h3 className="text-[44px] dark:text-[white] leading-[40px] font-[extrabold] mb-[33px]">
            Страхование
          </h3>
